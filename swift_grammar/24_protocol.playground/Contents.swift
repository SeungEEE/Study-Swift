...
// 프로토콜은 특정 역할을 수행하기 위한 메서드, 프로퍼티, 이니셜라이저 등의 요구사항 정의

// 구조체, 클래스, 열거형은 프로토콜 채택(Adopted)해서
// 프로토콜의 요구사항을 실제로 구현할 수 있음
// 어떤 프로토콜의 요구사항을 모두 따르는 타입은
// 그 '프로토콜을 준수한다(Conform)'고 표현함
// 프로토콜의 요구사항을 충족시키려면 프로토콜이 제시하는 기능을 모두 구현해야함
