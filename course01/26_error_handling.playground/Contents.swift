...
// 오류발생의 여지가 있는 throws 함수(메서드)는 try 사용하여 호출
// try, try?, try!

//MARK: do-catch

// 오류발생의 여지가 있는 throws 함수(메서드)는 do-catch 구문 활영하여 오류발생에 대비
...
// try?
// 별도의 오류처리 결과를 통보받지 않고 오류가 발생했으면 결과값으로 nil로 돌려받을 수 있음
